...
namespace nc
{
	...
	inline Vector2 Vector2::Normalized() const { return (Length() != 0) ? *this / Length() : Vector2::zero; }

	inline void Vector2::Normalize() { *this / Length(); }

	inline float Vector2::Angle() const { return std::atan2(y, x); }
	...
	inline float Vector2::Angle(const Vector2& v1, const Vector2& v2) { return std::acos(Dot(v1, v2)); }
